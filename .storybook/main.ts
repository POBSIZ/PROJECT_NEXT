...
module.exports = {
  ...
  webpackFinal: async (config) => {
    ...
    config.resolve.alias.Molecules = __dirname + "/../src/components/UI/molecules/";
    config.resolve.alias.Organisms = __dirname + "/../src/components/UI/organisms/";
    ...
    config.resolve.alias.StoriesLayout = __dirname + "/../src/components/UI/stories/storiesLayout/index.tsx";
